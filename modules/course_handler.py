...
# ============================================================
async def download_video_simple(video_url: str, name: str, quality: str = '720') -> str:
    """
    Simply download video using yt-dlp or ffmpeg
    """
    try:
        ...
        print(f"❌ Download timeout after {DOWNLOAD_TIMEOUT} seconds")
        return None
    except Exception as e:
...
async def download_and_upload_video(video_url: str, message: Message, client: Client, quality: str, batch_name: str, channel_id: int, index: int, video_id: str, title: str):
    ...
    for attempt in range(1, MAX_RETRIES + 1):
        try:
            ...
            # ✅ Simply download the URL from API
            downloaded_file = await download_video_simple(video_url, filename, quality)
    ...
    try:
        ...
        for idx, video_info in enumerate(video_list, start=1):
            ...
            try:
                ...
                # ✅ Directly download the URL from API
